...
export default function ManageAIModelsPage() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-yellow-50 to-cyan-50 p-8">
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-amber-600 mx-auto mb-4"></div>
            <p className="text-amber-600">Loading AI Models...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-amber-100 p-8 mb-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Manage AI Models</h1>
              <p className="text-gray-600">Create, edit, and manage your AI models</p>
            </div>
            <button
              onClick={handleCreate}
              className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-amber-600 to-yellow-600 text-white rounded-xl hover:from-amber-700 hover:to-yellow-700 transition-all duration-200 shadow-lg hover:shadow-xl"
            >
        ...
        {/* Error Alert */}
        {error && (
          <div className="bg-red-100 border border-red-300 text-red-700 px-4 py-3 rounded-xl mb-8">
            {error}
          </div>
        )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {aiModels.map((model) => (
            <div key={model.id} className="bg-white rounded-xl shadow-lg border border-amber-100 overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <div className="p-6">
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-gray-900">{model.architecture || 'N/A'}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-500">Dataset:</span>
                    <span className="text-gray-900">{model.dataset_used || 'N/A'}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-500">Access Level:</span>
                    <span className="text-gray-900">{model.access_level}</span>
                  </div>
                </div>

                {model.metrics && (
                  <div className="bg-amber-50 rounded-lg p-3 mb-4">
                    <p className="text-xs font-medium text-amber-800 mb-2">Performance Metrics</p>
                    <div className="grid grid-cols-3 gap-2 text-xs">
                      ...
                      {model.metrics.f1_score && (
                        <div>
                          <span className="text-amber-600">F1 Score:</span>
                          <br />
                      ...
                      {model.metrics.loss && (
                        <div>
                          <span className="text-amber-600">Loss:</span>
                          <br />
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {model.categories.map((category, index) => (
                        <span key={index} className="inline-block px-2 py-1 bg-amber-100 text-amber-800 text-xs rounded-md">
                          {category}
                        </span>
                      ))}
                    </div>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="flex-1 px-3 py-2 bg-amber-600 text-white text-sm rounded-lg hover:bg-amber-700 transition-colors"
                  >
                    Edit
                  </button>
                  <button
        ...
        {aiModels.length === 0 && (
          <div className="text-center py-12">
            <div className="bg-white rounded-2xl shadow-lg border border-amber-100 p-12">
              ...
              <h3 className="mt-6 text-lg font-medium text-gray-900">No AI Models Found</h3>
              <p className="mt-2 text-gray-500">Get started by creating your first AI model.</p>
              <button
                onClick={handleCreate}
                className="mt-6 inline-flex items-center px-6 py-3 bg-gradient-to-r from-amber-600 to-yellow-600 text-white rounded-xl hover:from-amber-700 hover:to-yellow-700 transition-all duration-200"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                </svg>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {modalMode !== 'view' && (
                    <div className="flex gap-4 pt-6">
                      ...
                      <button
                        type="submit"
                        className="flex-1 px-6 py-3 bg-gradient-to-r from-amber-600 to-yellow-600 text-white rounded-lg hover:from-amber-700 hover:to-yellow-700 transition-all duration-200 disabled:opacity-50"
                        disabled={isSubmitting}
                      >
