          ...
          <div className="flex justify-center mb-8">
            <div className="inline-flex bg-white/10 backdrop-blur-sm rounded-xl p-1 border border-white/20">
              <button
                ...
                className={`px-6 py-2 rounded-lg transition-all duration-300 ${viewMode === "grid" ? "bg-gradient-to-r from-amber-500 to-yellow-500 text-white" : "text-gray-300 hover:text-white"}`}
              >
              ...
              <button
                ...
                className={`px-6 py-2 rounded-lg transition-all duration-300 ${viewMode === "masonry" ? "bg-gradient-to-r from-amber-500 to-yellow-500 text-white" : "text-gray-300 hover:text-white"}`}
              >
                <svg className="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-12">
            {categories.map((category) => (
              <button
                ...
                className={`px-6 py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-105 ${selectedCategory === category.id ? "bg-gradient-to-r from-amber-500 to-yellow-500 text-white shadow-lg" : "bg-white/10 backdrop-blur-sm text-gray-300 hover:bg-white/20 border border-white/20"}`}
              >
        ...
        <div className="container mx-auto px-6 lg:px-8">
                ...
                >
                  <div className={`relative ${viewMode === "masonry" && index % 3 === 0 ? "h-96" : "h-72"}`}>
                    {item.image_url ? (
                      ...
                      <div className={`absolute inset-0 bg-gradient-to-br ${item.gradient || "from-amber-500 to-yellow-500"}`}>
          ...
          {!loading && filteredItems.length > 0 && (
            <div className="text-center mt-12">
              <button className="group inline-flex items-center px-8 py-4 bg-gradient-to-r from-amber-500 to-yellow-500 text-white font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-2xl">
      ...
      {selectedImage && (
        <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-4" onClick={closeModal}>
          <div className="relative max-w-6xl w-full" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="grid md:grid-cols-2 gap-6 bg-slate-900 rounded-2xl overflow-hidden">
              <div className={`relative h-96 md:h-[600px] ${!selectedImage.image_url ? `bg-gradient-to-br ${selectedImage.gradient || "from-amber-500 to-yellow-500"}` : ""}`}>
              ...
              <div className="p-8">
                ...
                <div className="flex gap-3">
                  <button className="flex-1 px-6 py-3 bg-gradient-to-r from-amber-500 to-yellow-500 text-white font-semibold rounded-xl hover:shadow-lg transition-all duration-300">
                    <svg className="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                    </svg>
                    Download
